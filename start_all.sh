...
echo "==============================="
echo " Golf Cart v8.3 启动"
echo "==============================="

# 清理旧进程
pkill -9 -f 'golf_\|yolo\|camera_info_fix\|lx_camera\|nmea_serial\|lslidar\|summon_service\|mqtt_bridge\|imu_ned_to_enu\|yesense_node\|ekf_gps\|navsat_transform\|mode_manager\|lock_manager\|gesture_node\|gps_path_recorder\|gps_waypoint_follower\|follow_target_publisher' 2>/dev/null || true
...
# Step 3: follow（模式管理 + PID 跟随 + GPS 路点记录 + GPS 脉冲导航 + 召唤 + MQTT）
echo "[3/3] 启动 follow..."
