...
| `summon_service` | APP 召唤请求分发器，支持球洞名和 GPS 坐标两种召唤方式 | `/summon_request`, `/nav_complete` | `/nav_trigger`, `/summon_result` |
...
- **下游**：
  ...
  - `golf_bringup/mqtt_bridge` 订阅 `/system_mode`、`/nav_complete`、`/summon_result` 转发到 APP
